...
class MainSend(QtGui.QMainWindow):
	...
	def close_button(self):
		...
		close_btn = QtGui.QPushButton("Disconnect", self)
		close_btn.clicked.connect(self.close)
		close_btn.resize(100, 45)
		close_btn.move(10, 545)
		close_btn.setStyleSheet("font-weight: 700; color: #00ffbc")
